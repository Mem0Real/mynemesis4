...
export default function Modal({ showAddModal, hideAddModal, addData }) {
  ...
  return (
    <div
      ...
      tabindex="-1"
      aria-hidden="true"
      className={`fixed top-2 bottom-2 md:top-6 left-10 md:left-1/4 lg:left-1/3 z-50 ${
        !showAddModal ? "hidden" : ""
      }  w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)]`}
    >
      <div className="w-3/4 lg:w-1/3">
        <div className="bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div className="w-full px-2 md:px-11 pb-24 lg:py-6">
